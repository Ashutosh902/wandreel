...
export function BucketlistSummary({ onSelectCategory }: { onSelectCategory: (category: CategoryLabel) => void }) {
  return (
    <section className="wr-bucketlist-wrap">
      ...
      <div className="wr-bucketlist-card">
        ...
        <div className="wr-bucket-top">
          ...
          <button type="button" className="wr-bucket-view-all">View all</button>
        </div>
              ...
              >
                ...
                <div className="wr-bucket-item-content">
                  ...
                  <div>
                    ...
                    <p className="wr-bucket-item-count">{cat.count}</p>
                  </div>
                </div>
              </button>
            );
